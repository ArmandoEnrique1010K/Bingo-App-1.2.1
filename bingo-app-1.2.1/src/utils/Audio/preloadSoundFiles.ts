...
import { BALLS_SOUND, CLICK_SOUND, CORRECT_SOUND, WRONG_SOUND, VICTORY_SOUND } from "../../constants/audioSettings";

export const preloadedSoundPlayers = new Map<string, Tone.Player>();

export const preloadSoundFiles = async () => {
  try {
    const sounds = [WRONG_SOUND, CORRECT_SOUND, BALLS_SOUND, CLICK_SOUND, VICTORY_SOUND]
